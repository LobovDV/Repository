...
//        mockMvc.perform(formLogin("/signin").user("test@test.com").password("123 123"))
//                .andDo(print())
//                .andExpect(status().is3xxRedirection())
//                .andExpect(redirectedUrl("/"));
//
//        mockMvc.perform(formLogin("/signin").user("+7(903)123-23-23").password("123 123"))
//                .andDo(print())
//                .andExpect(status().is3xxRedirection())
//                .andExpect(redirectedUrl("/"));
//    }
    ...
    public void testSearchQuery() throws Exception {
        mockMvc.perform(get("/search/Acacias"))
                .andDo(print())
